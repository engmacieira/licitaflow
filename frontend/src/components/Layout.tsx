...
// CORREÇÃO: Adicionei 'Layers' na lista de imports
import { LayoutDashboard, FileText, FolderOpen, Settings, Ghost, Layers } from 'lucide-react';
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-gray-900 text-white flex-col hidden md:flex shadow-xl">
        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          {/* LINK NOVO: Planejamento (Consolidação) */}
          <Link to="/planejamento" className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive('/planejamento')}`}>
            <Layers size={20} />
            <span className="font-medium">Planejamento (PCA)</span>
          </Link>
